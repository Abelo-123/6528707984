...
const Tab = () => {
    ...
    return (
        ...
        <>
            ...
            <Tabbar style={{ background: ' var(--tgui--secondary_bg_color)', border: '2px solid transparent', display: 'grid', margin: '0rem', placeItems: 'center', gridTemplateColumns: 'repeat(4, 1fr)' }}>
