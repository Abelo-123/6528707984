            ...
            <Tabbar style={{ background: 'none', border: '1px solid var(--tgui--section_bg_color)', display: 'grid', margin: '0rem', placeItems: 'center', gridTemplateColumns: 'repeat(4, 1fr)' }}>
                <Tabbar.Item onClick={() => updateActivePage(1)}>
                    <div className='flex flex-col'>
                        ...
                        <FontAwesomeIcon icon={faClock} style={{ color: activePage === 1 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '1.6rem' }} />
                ...
                <Tabbar.Item onClick={() => updateActivePage(2)}>
                    <div className='flex flex-col'>
                        <FontAwesomeIcon icon={faFacebookMessenger} style={{ color: activePage === 2 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '1.6rem' }} size="2x" />
                ...
                <Tabbar.Item onClick={() => updateActivePage(3)}>
                    <div className='flex flex-col'>
                        <FontAwesomeIcon icon={faUser} style={{ color: activePage === 3 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '1.6rem' }} size="2x" />
                ...
                <Tabbar.Item onClick={() => updateActivePage(4)}>
                    <div className='flex flex-col'>
                        <FontAwesomeIcon icon={faUser} style={{ color: activePage === 4 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '1.6rem' }} size="2x" />
                ...
                <Tabbar.Item onClick={() => updateActivePage(5)}>
                    <div className='flex flex-col'>
                        <FontAwesomeIcon icon={faCalendar} style={{ color: activePage === 5 ? 'var(--tgui--link_color)' : 'var(--tgui--subtitle_text_color)', fontSize: '1.6rem' }} size="2x" />
