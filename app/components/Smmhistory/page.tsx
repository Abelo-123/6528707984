    ...
    return (
        <>
            ...
            >
                ...
                <div className='z-90   w-full absolute place-content-center grid place-content-end absolute  ' onClick={() => window.location.href = 'https://t.me/paxyo_bot'} style={{ margin: '1rem -0.9rem', fontSize: '0.8rem', height: '3rem', zIndex: 900, }} >
