    ...
    return (
        <>
            ...
            >
                ...
                <Section header="Order History" style={{ width: '95%', marginTop: '-1rem', border: '1px solid var(--tgui--section_bg_color)' }}>
                    <div style={{ borderRadius: '10px' }} className="scrollabler overflow-x-auto">
                        {loader && <MyLoader />}
